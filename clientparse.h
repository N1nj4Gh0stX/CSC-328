...
/*	    responsible for parsing command-line.
/*	    It also includes the struct options variables that will 
/*	    be declared in parse.c.
/************************************************************/
#ifndef PARSE_H
#define PARSE_H
...
/*		the directory, and the call to verbose. Port is required by 
/* 		the user, while the directory and verbose have default
/*		values.
